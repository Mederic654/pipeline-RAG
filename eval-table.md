...
| # | Type | Question | Top-1 score | Avg score | Sources | Réponse | Notes |
|---|------|----------|-------------|-----------|---------|---------|-------|
| 1 | Happy | Comment définir un outil dans Pydantic AI ? | ... | ... | ... | ... | ... |
...
| 5 | Happy | Comment utiliser les modèles OpenAI avec Pydantic AI ? | ... | ... | ... | ... | ... |
| 6 | Happy | Comment fonctionnent les evals dans Pydantic AI ? | ... | ... | ... | ... | ... |
